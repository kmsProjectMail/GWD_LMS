...
<div class="container">
	<div class="form-inline my-2 my-lg-0" style="float: right; width: 30%; margin: 5%;">
      ...
      <button class="btn btn-outline-success my-2 my-sm-0 " onclick="searchMeet()">검색</button>
    </div>
      ...
      <div class="modal-footer">
          <div class="col-sm-11">
              <div class="col-sm-offset-2">
                  <button id="btn-save-schedule" type="button" class="btn col-sm-4 " style="float: left; width: 40%;" onclick="modify()">
